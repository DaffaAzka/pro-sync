<x-templates>
    ...
    <div class="h-screen flex items-center justify-center">
        <div class="w-11/12 max-w-96 p-6 pb-8 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white text-center">Register Account</h5>
            ...
            <form class="max-w-md mx-auto my-3" method="POST" action="{{route('register.store')}}">
                @csrf
                ...
                <div class="flex justify-center mt-4">
                    <button type="submit" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-purple-700 rounded-lg hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">
                        Submit
...
{{--                        </svg>--}}
            ...
            <p class="text-center text-sm mt-4">
                <a href="{{ route('login') }}">Already have an account? <span class="underline text-purple-800">Click here</span> to login!</a>
            </p>
        </div>
    </div>
