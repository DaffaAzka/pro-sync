        ...
        <form class="w-full mx-auto mb-4" method="get" action="{{ route('lists.project') }}">
            <div class="flex">
                <div class="relative w-full">
                    <input type="search" name="title" id="location-search" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Search project..." required />
