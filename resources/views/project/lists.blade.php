            ...
            @foreach($projects as $project)
                <div class="md:span p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col h-full">
                    <div class="grid gap-y-3 flex-grow">
                        ...
                        <p class="font-normal text-sm text-gray-600 line-clamp-2">{{ $project['description'] }}</p>
                    </div>
                    <div class="flex my-1.5 space-x-2 mt-3.5 w-full">
                        ...
                        <div data-popover id="popover-{{$project['slug']}}-description" role="tooltip" class="absolute z-10 invisible inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 w-auto dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">
